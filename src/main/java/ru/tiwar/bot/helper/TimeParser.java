...
public class TimeParser {
    ...
    public static Long extractSecondsFromElementIdValue(SelenideElement selenideElement) {
        String timeMsec = selenideElement.getAttribute("id").replaceAll("\\D+", "");
        return Long.parseLong(timeMsec) / 1000L;
    }
}
